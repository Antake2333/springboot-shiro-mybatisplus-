...
public class LogAspect {
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logService.save(joinPoint,log,JwtUtil.getUserId(JwtUtil.getTokenFromRequest()),JwtUtil.getUsername(JwtUtil.getTokenFromRequest()), StringUtils.getBrowser(request),StringUtils.getIp(request));
        return result;
    }
    /**
     * 配置异常通知
    ...
    public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
        ...
        HttpServletRequest request = JwtUtil.getRequest();
        logService.save((ProceedingJoinPoint) joinPoint,log,JwtUtil.getUserId(JwtUtil.getTokenFromRequest()),JwtUtil.getUsername(JwtUtil.getTokenFromRequest()), StringUtils.getBrowser(request),StringUtils.getIp(request));
    }
}
